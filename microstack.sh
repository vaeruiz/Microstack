...
clear
echo "Se ha configurado la máquina como nodo controaldor. Realice conexiones ssh desde el nodo de control al resto de nodos para poder llevar a cabo el traspaso de archivos."
